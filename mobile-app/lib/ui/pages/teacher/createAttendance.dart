...
class CreateAttendance extends StatefulWidget {
  ...
  const CreateAttendance({super.key, this.courseId, this.courseName});

  @override
  _CreateAttendance createState() => _CreateAttendance(courseId, courseName);
}

class _CreateAttendance extends State<CreateAttendance> {
  String? courseId;
  String? courseName;
  List<String> selectedStudent = <String>[];

  _CreateAttendance(this.courseId, this.courseName);
  ...
  Widget build(BuildContext context) {
    ...
    //final attendanceDetail = teacherProvider.attendanceDetail;
    ...
    createAttendance() async {
      ...
      final Future<Map<String, dynamic>> successfulMessage = teacherProvider
          .createAttendance(present, absent, selectedStudent, courseId!);
